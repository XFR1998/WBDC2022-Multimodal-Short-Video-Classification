...
def parse_args():
    ...
    parser.add_argument('--test_output_csv', type=str, default='../../data/result_双流_testb.csv')
    ...
    parser.add_argument('--saved_kfold_model_path', type=str, default='./save/kfold_model')
    parser.add_argument('--ckpt_file', type=str, default='save/v1/model_epoch_3_mean_f1_0.6721.bin')
    ...
    # ========================== My tricks =============================
    parser.add_argument('--ema', type=bool, default=True, help="whether use ema or not")
    parser.add_argument('--use_fgm', type=bool, default=True, help="whether use fgm or not")
