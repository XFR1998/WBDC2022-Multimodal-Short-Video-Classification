...
def parse_args():
    ...
    #parser.add_argument('--train_annotation', type=str, default='../data/annotations/unlabel+train+test.json')
    ...
    parser.add_argument('--ckpt_file', type=str, default='save/v1/model_epoch_2_mean_f1_0.6473.bin')
    ...
    parser.add_argument('--use_all_pretrain_data', type=bool, default=True, help="whether use all_pretrain_data or not")
