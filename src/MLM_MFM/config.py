...
def parse_args():
    ...
    parser.add_argument('--ckpt_file', type=str, default='save/v1/model_epoch_4_mean_f1_0.6721.bin')
    ...
    #parser.add_argument('--bert_dir', type=str, default='./save_roberta_base1')
