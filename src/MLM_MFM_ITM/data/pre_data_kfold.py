...
class MultiModalDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> dict:
        ...
        ocr_text = '。'.join([i['text'] for i in self.anns[idx]['ocr']]) #self.anns[idx]['ocr']
        ...
        cat_input, cat_mask = self.tokenize_text(cat_text, max_len=self.maxlen)
