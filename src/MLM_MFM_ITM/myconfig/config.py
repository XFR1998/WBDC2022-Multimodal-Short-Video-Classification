...
def parse_args():
    ...
    parser.add_argument('--unlabel_annotation', type=str, default='../../data/annotations/unlabeled.json')
    ...
    parser.add_argument('--unlabel_zip_feats', type=str, default='../../data/zip_feats/unlabeled.zip')
    ...
    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='/save/kfold')
    parser.add_argument('--ckpt_file', type=str, default='/fineturn/model_epoch_5_mean_f1_0.6804.bin')
    ...
    parser.add_argument('--fineturn_model', type=str, default='/save/best_pretrain_model.pth')
    parser.add_argument('--config_json', type=str, default='../myconfig/config_base.json')
    parser.add_argument('--saved_kfold_model_path', type=str, default='/save/kfold')
    parser.add_argument('--saved_kfold_logits', type=str, default='../kfold_logits/')
    parser.add_argument('--kfold_data_path', type=str, default='../../data/kfold_data/')
    parser.add_argument('--maxlen', type=int, default=468, help="seq max len")
    parser.add_argument('--use_all_pretrain_data', type=bool, default=False, help="seq max len")
    parser.add_argument('--use_all_data', type=bool, default=False, help="whether use pgd or not")
    ...
    parser.add_argument('--use_swa', type=bool, default=False, help="whether use pgd or not")
